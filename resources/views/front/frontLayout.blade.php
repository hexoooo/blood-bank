...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="social">
                            <div class="icons">
                                ...
                                <a href="{{$contactInfo->first()->facebook_link}}" class="facebook"><i class="fab fa-facebook-f"></i></a>
                                <a href="{{$contactInfo->first()->insta_link}}" class="instagram"><i class="fab fa-instagram"></i></a>
                                <a href="{{$contactInfo->first()->twitter_link}}" class="twitter"><i class="fab fa-twitter"></i></a>
                                <a href="{{$contactInfo->first()->phone}}" class="whatsapp"><i class="fab fa-whatsapp"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="info" dir="ltr">
                            <div class="phone">
                                ...
                                <p>{{$contactInfo->first()->phone}}</p>
                            </div>
                            <div class="e-mail">
                                <i class="far fa-envelope"></i>
                                <p>{{$contactInfo->first()->email}}</p>
                            </div>
                        </div>
     ...
     @yield('content')
                ...
                <div class="container">
                    <div class="row">
                        <div class="details col-md-4">
                            <img src="{{asset('imgs/logo-ltr.png')}}">
                            <h4>Blood Bank</h4>
                            <p>
        ...
        <script src="https://cdn.js')}}delivr.net/npm/popper.js')}}@1.16.1/dist/umd/popper.min.js" integrity="sha384-9/reFTGAW83EW2RDu2S0VKaIzap3H66lZH81PoYlFhbGU+6BZp6G7niu735Sk7lN" crossorigin="anonymous"></script>
      
        <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js" integrity="sha384-B4gt1jrGC7Jh4AgTPSdUtOBvfO8shuf57BaghqFfPlYxofvL8/KUEfYiJOMMV+rV" crossorigin="anonymous"></script>
        
        <script src="{{asset('assets/js/owl.carousel.min.js')}}"></script>
        
        <script src="{{asset('assets/js/main-ltr.js')}}"></script>
    </body>
</html>