            ...
            <div class="container">
                ...
                <div class="account-form">
                    ...
                    <form method="post" action="/create-new" >
                        ...
                        <input placeholder="Birth date" class="form-control" type="text" onfocus="(this.type='date')" id="date" name="dob">
                        ...
                        <div class="create-btn">
                            <button type="submit" value="Creat">create new account</button>
                        </div>
                    </form>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="pages col-md-4">
                            <div class="list-group" id="list-tab" role="tablist">
                                <a class="list-group-item list-group-item-action" id="list-home-list" href="index-ltr.html" role="tab" aria-controls="home">Home</a>
